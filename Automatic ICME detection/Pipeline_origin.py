...
class Pipeline(object):
    ...
    def fit(self):
        ...
        callbacks.append(ModelCheckpoint('G:/ICME/model_origin_2/' + self.model + '/' + str(ratio) + '_' + str(self.windows)
        ...
        history = model.fit_generator(generator=train_data.__iter__(), epochs=self.epoch, steps_per_epoch=10000,
                                      ...
                                      callbacks=callbacks, initial_epoch=65)
    ...
    def test(self,):
        ...
        np.save('G:/ICME/result_origin_2/' + self.model + '/' + str(ratio) + '_' + str(self.windows) + '/100.npy', pre_label)
    ...
    def eval(self):
        ...
        # 获取预测的ICME间隔
        prediction = np.load('G:/ICME/result_origin_1/' + self.model + '/' + str(ratio) + '_' + str(self.windows) + '/100.npy')
